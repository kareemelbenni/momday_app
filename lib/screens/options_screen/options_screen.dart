...
class OptionsScreenState extends State<OptionsScreen> {
  ...
  List<Widget> _options(){
    ...
    if(this.widget.product.availableOptions != null && this.widget.product.availableOptions.length != 0) {
      ...
      for (OptionModel option in this.widget.product.availableOptions.keys) {
        ...
        for (OptionValueModel optionValue in widget.product.availableOptions[option]) {
