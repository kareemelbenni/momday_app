  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: CustomScrollView(
        slivers: <Widget>[
          SliverToBoxAdapter(
            child: MainScreen.of(context).getMomdayBar()
          ),
          SliverPadding(
...
class _MomsaySummaries extends StatelessWidget {
  ...
  Future<List<MomsayPostSummaryModel>> _pageFuture(pageIndex) async {
    final posts = await MomdayBackend().getMomsayPostSummaries(
              ...
              Row(
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      CircleAvatar(
                        backgroundImage: AssetImage("assets/images/no_image_author.png"),
//                        backgroundImage: CachedNetworkImageProvider(summary.author.image),
                  ...
                  Text(
                    convertDateToUserFriendly(summary.date, Localizations.localeOf(context).languageCode),
                                ...
                                Expanded(
                                  child: LayoutBuilder(
                                    builder: (context, constraints) {
                                      final maxLines = (constraints.maxHeight / Theme.of(context).textTheme.body1.fontSize).floor();
                                      return DefaultTextStyle(
                                        style: cancelArabicFontDelta(context),
                                        maxLines: maxLines,
                                        child: Html(
                                          data: _parseHtmlString(summary.description),
                                        ),
                                      );
                                    },
                                  ),
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      ...
                      Text(
                        convertNumberToUserFriendly(summary.likes, Localizations.localeOf(context).languageCode),
                        style: TextStyle(
                            fontSize: 8.0,
                            color: MomdayColors.NoteGray
                        ),
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushNamed('/momsay-post/${summary.id}');
                    },
                  )
                ],
              )
