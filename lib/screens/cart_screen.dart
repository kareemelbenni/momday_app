...
class ContinueToPaymentButton extends StatefulWidget {
  ...
  @override
  _ContinueToPaymentButtonState createState() => _ContinueToPaymentButtonState();
}
    ...
    return Column(
      ...
      children: <Widget>[
        RaisedButton(
          ...
          onPressed: (){
            if (widget.existingAddressesKey.currentState.selectedAddress == null) {
              setState(() {
